...
在vowels中，5个为日语的a.wav, i.wav, u.wav, e.wav, o.wav，剩下的则为ai.wav（发音/aɪ/，用a.wav和i.wav组合）, ax.wav（发音/ə/，通过插件调整o.wav的共振峰得到）, ei.wav（发音/eɪ/，用e.wav和i.wav组合）, er.wav（发音/ər/，用e.wav和辅音文件夹里的r-.wav组合）, ew.wav（发音/ɛw/，用ax.wav和u.wav组合）, oi.wav（发音/ɔɪ/，用o.wav和i.wav组合）, ou.wav（发音/oʊ/，用o.wav和u.wav组合）
